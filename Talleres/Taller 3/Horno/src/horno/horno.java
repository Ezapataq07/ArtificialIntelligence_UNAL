...
public class horno {
    ...
    public static void main(String[] args) {
        ...
        String fileName = "src/horno/horno.fcl";
        ...
        fis.setVariable("humedad", 2);
        fis.setVariable("intensidad", 2);
        fis.setVariable("volumen", 2.5);
       ...
       //
        ...
        Variable tip = fis.getVariable("temperatura");
        ...
        System.out.println("La temperatura del horno es: " + String.format("%.1f", salida) + "°\n");
        /*
        //
